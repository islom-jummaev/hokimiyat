    ...
    <ul class="sidebar-menu">
      ...
      <li>
        <a href="admin_profile.php">
          <i class="fa fa-flag"></i> <span>Profil</span>
        </a>
      </li>
      <li>
        <a href="class_room.php">
          <i class="fa fa-list-ul"></i> <span>Bo'limlar</span>
        </a>
      </li>
      <li>
        <a href="grade.php">
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li><a href="teacher.php"><i class="fa fa-circle-o"></i> Xodim qo'shish</a></li>
          <li><a href="all_teacher.php"><i class="fa fa-circle-o"></i>Xodimlar soni</a></li>
        </ul>
      </li>
      <li>
